...
*&---------------------------------------------------------------------*
*&  Integrate the trainer model                                        *
*&                                                                     *
*&  Create instances of lcl_rental, lcl_vehicle, lcl_bus and lcl_truck *
*&  implement lif_partner in lcl_rental                                                                     *                                  *
*&---------------------------------------------------------------------*
REPORT  zbc401_07_main11.

TYPE-POOLS icon.

INCLUDE ZBC401_07_MAIN11_PAR.
*INCLUDE bc401_int_s3_agency.
INCLUDE ZBC401_07_MAIN11_CAR.
*INCLUDE bc401_int_s3_carrier.
INCLUDE ZBC401_07_MAIN11_RENTAL.
